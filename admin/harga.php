                  ...
                  <tbody>
                    ...
                    while($d = mysqli_fetch_array($data)){
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="edit_harga.php?id_harga=<?php echo $d['id_harga']; ?>" class="btn btn btn-warning">Edit</a>
                          <a href="hapus_harga.php?id_harga=<?php echo $d['id_harga']; ?>" class="btn btn btn-danger">Hapus</a>
                        </td>
                      </tr>
                      <?php
                    }
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Tambah Harga Kamar</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
          <form action="tambah_harga.php" method="POST">
            ...
            <div class="form-group">
              <label>Harga</label>
              <textarea name="harga" class="form-control" rows="1"></textarea>
            </div> 
          </div>
